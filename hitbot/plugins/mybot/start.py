    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            ...
            await tgbot.send_message(event.chat_id,
                                     ...
                                     buttons=[
                                         [Button.url(
                                             "TeleBot", url="https://github.com/king-cobra-user/HITMAN-USERBOT")],
                                         [Button.inline(
                                             "Whats this?", data="telebot")]
                                     ]
                                     )
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/king-cobra-user/HITMAN-USERBOT")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Fxditya%2FHITMANBot%2F&template=https%3A%2F%2Fgithub.com%2FKing-cobra-user%2FHITMAN-USERBOT"))],
                         [Button.url("Support",
                                     url="https://t.me/HITUSERBOT")]
                     ])
