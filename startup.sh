# Copyright (C) 2020-2021 by Terabaap@Github, < https://github.com/DevsExpo >.
#
# This file is part of < https://github.com/king-cobra-user/HITMAN-USERBOT > project,
# and is released under the "GNU v3.0 License Agreement".
# Please see < https://github.com/King-cobra/blob/master/LICENSE >
#
# All rights reserved.
