...
class Config(object):
    ...
    ASSISTANT_START_PIC = os.environ.get("ASSISTANT_START_PIC", "https://starkapis.herokuapp.com/shazam/", files=f)
    try:
    ...
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/king-cobra-user/HITMAN-USERBOT")
    ALIVE_IMG = os.environ.get("ALIVE_IMG", "https://telegra.ph/file/736fa312782f1dfaea837.jpg")    U_BRANCH = "master"
