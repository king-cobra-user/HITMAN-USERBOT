...
from main_startup import Hitman, Hitman2, Hitman3, Hitman4
...
def cb_wrapper(func):
    async def wrapper(client, cb):
        ...
        if cb.from_user.id not in users:
            await cb.answer(
                "You Can't Access Me, Only My Master Can. Why Don't You Deploy Your Own Hitman
- @Hitmanuserbotchat",
                cache_time=0,
                show_alert=True,
            )
                    ...
                    (
                        InlineQueryResultArticle(
                            ...
                            input_message_content=InputTextMessageContent(
                                "**Hai!** Well, I am Not For You, I Only Work For My Master. Why Don't You Deploy Your Own @Hitmanuserbotchat ?"
                            ),
                        )
                    )
                ],
